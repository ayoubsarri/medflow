...
// Mock staff user database
const staffUsers = [
  { email: "admin@clinic.com", password: "password123", role: "Admin", name: "System Administrator" },
  { email: "lyne@clinic.com", password: "password123", role: "Admin", name: "Lyne Admin" },
...
export default function StaffLoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      // Store staff info and redirect to dashboard
      ...
      router.push(roleRoutes[staff.role]);
    }, 800);
  };
